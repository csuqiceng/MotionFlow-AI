...
foreach ($required in @(
    "robot_server.exe", "NANOBOT_HOME", "NANOBOT_DEFAULTS_DIR", "ROBOT_AI_BACKEND",
    "/health", "<title>", 'id="root"', "nanobot web UI", "taskkill", "contains spaces", "robot_platform", "PSScriptRoot is initialized",
    "configArgument", '"{0}"'
)) {
