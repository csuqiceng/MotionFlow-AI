    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild disabled={disabled || !onChange}>
        <Button
          ...
          className={cn(
            "max-w-[min(12.5rem,42vw)] rounded-lg border border-transparent font-semibold shadow-none",
            isHero ? "h-8 px-2.5 text-[12px]" : "h-9 px-3 text-[12.5px]",
            isFull
              ? "bg-transparent text-warning hover:bg-warning/10 dark:text-warning"
  ...
  return (
    <DropdownMenuItem
      ...
      className={cn(
        ...
        warning && "text-warning focus:text-warning dark:text-warning dark:focus:text-warning",
      )}
    >
