...
class SafetyLimits:
    ...
    # Product contract: percentages in the controller's documented (0, 100]
    # range are accepted.  Values above 100 are rejected by L1 before permit
    # issuance or controller dispatch.
    safe_speed_max: float = 100.0
    safe_acc_max: float = 100.0
    safe_dec_max: float = 100.0
